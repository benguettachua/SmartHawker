...
class SingleCalendarViewController: UIViewController {
    var numberOfRows = 2
...
extension SingleCalendarViewController: JTAppleCalendarViewDataSource, JTAppleCalendarViewDelegate {
